...
const CalendarModal: React.FC<CalendarModalProps> = ({ 
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center z-50 p-4 pt-safe" onClick={onClose}>
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-4xl p-6 relative animate-fade-in-up" onClick={(e) => e.stopPropagation()}>
                {/* 월 이동 버튼들 */}
                        ...
                        return (
                            <div 
                                ...
                                className={`
                                    ...
                                    ${isSunday 
                                        ? 'bg-red-50/30 dark:bg-red-900/20 text-red-600 dark:text-red-400' // 일요일: 연한 빨간색
                                        : isSaturday 
                                            ? 'bg-blue-50/30 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' // 토요일: 연한 파란색
                                            : 'bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100' // 평일: 기본색
                                    }
                                `}
                            >
                                {day}
                    ...
                    {calendarData.map((day, index) => (
                        <div 
                            ...
                            className={`
                                ...
                                ${day.isCurrentMonth 
                                    ? (day.isHoliday 
                                        ? 'bg-red-50/30 dark:bg-red-900/20 text-red-600 dark:text-red-400' // 공휴일: 연한 빨간색
                                        : day.isSunday 
                                            ? 'bg-red-50/30 dark:bg-red-900/20 text-red-600 dark:text-red-400' // 일요일: 연한 빨간색
                                            : day.isSaturday 
                                                ? 'bg-blue-50/30 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' // 토요일: 연한 파란색
                                    ...
                                    if (isVacationSchedule) {
                                        ...
                                        hoverColor = 'hover:bg-gray-600';
                                                        ...
                                                        return (
                                                            <div
                                                                key={eventIndex}
                                            className={`text-[10px] sm:text-xs md:text-sm lg:text-sm xl:text-sm ${bgColor} ${hoverColor} text-white px-1 sm:px-2 py-1 rounded cursor-pointer break-words leading-tight`}
