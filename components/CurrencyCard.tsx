...
const CurrencyCard: React.FC<CurrencyCardProps> = memo(({ title, currencyInfo, onClick, cardType, expiryDate }) => {
    ...
    if (!currencyInfo) {
        return (
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-4 sm:p-6 cursor-pointer flex flex-col justify-center h-full min-h-[120px] sm:min-h-[140px]">
    ...
    if (isDocumentCard) {
        ...
        return (
            <div onClick={onClick} className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-4 sm:p-6 cursor-pointer flex flex-col justify-center h-full min-h-[120px] sm:min-h-[140px]">
                <div className="flex items-center justify-between">
                    <h3 className="text-lg font-bold text-gray-800 dark:text-gray-200">{title}</h3>
                </div>
                <div className="mt-2 text-center flex-1 flex flex-col justify-center">
                ...
                <div className="mt-3 py-2 px-3 rounded-lg text-center">
                    {formattedDate ? (
                        <p className="text-sm text-gray-800 dark:text-white" style={{ fontSize: '0.8rem' }}>
                            {formattedDate}
                        </p>
                    ) : (
